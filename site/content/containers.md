...
> **Published with 1.0.0 (2026-09-19).** `ghcr.io/daemon-vi/cadre` has the tags `1.0.0`, `1.0` and
> `latest`, and pulls without logging in. The release workflow's smoke test ran it as user 10001
